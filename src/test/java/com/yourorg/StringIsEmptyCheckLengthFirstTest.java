...
class StringIsEmptyCheckLengthFirstTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        ...
        spec.recipe(new StringIsEmptyCheckLengthFirstRecipe());
    ...
    void recipeDocumentation() {
        ...
        Recipe recipe = new StringIsEmptyCheckLengthFirstRecipe();
